...
def main():
    ...
    es_tokenizer = AutoTokenizer.from_pretrained( modelName, src_lang="es_Latn")
    ...
    tokenizer = AutoTokenizer.from_pretrained( modelName, src_lang="aym_Latn")
    ...
    tokenizer = AutoTokenizer.from_pretrained( modelName, src_lang="gn_Latn")
